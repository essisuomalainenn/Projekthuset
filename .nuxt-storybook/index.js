...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"projekt-huset","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_3e00a38e === 'function') {
  ...
  if (typeof nuxt_plugin_prismic_4272693c === 'function') {
    await nuxt_plugin_prismic_4272693c(app.context, inject)
  }
